      ...
      <div className="max-w-7xl mx-auto">
        <GlassSurface variant="nav" density="light" className="px-4 sm:px-6 lg:px-7">
          ...
          <div className="flex items-center justify-between gap-3 py-3">
            ...
            <nav className="hidden 2xl:flex min-w-0 flex-1 items-center justify-center gap-1">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
            ...
            <button
              ...
              className="2xl:hidden p-2 rounded-md text-gray-700 hover:text-primary-600 hover:bg-white/80 transition-colors"
          ...
          {isMenuOpen && (
            <div className="2xl:hidden border-t border-primary-100/70 py-4 animate-fade-in">
